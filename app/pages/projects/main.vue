          ...
          <li @click="navigate()" class="flex items-center justify-between gap-3 py-3 px-4 sm:px-6">
            <div class="flex items-center gap-3 min-w-0">
              ...
              <div class="text-sm min-w-0">
                ...
                <p class="text-gray-900 dark:text-white font-medium truncate">ออกแบบ Project มาเพื่อใช้สำหรับขนส่งอาหารให้ถึงมือผู้บริโภค</p>
              </div>
            </div>
          ...
          <li @click="navigate()" class="flex items-center justify-between gap-3 py-3 px-4 sm:px-6">
            <div class="flex items-center gap-3 min-w-0">
              ...
              <div class="text-sm min-w-0">
                ...
                <p class="text-gray-900 dark:text-white font-medium truncate">เขียนเว็บเพื่อจัดการการจ่ายเงินเดือนพนักงาน</p>
              </div>
            </div>
            <div class="flex items-center gap-3">
              <div class="relative">
